...
require 'spree_sociable/version'

Gem::Specification.new do |spec|
  spec.platform    = Gem::Platform::RUBY
  spec.name        = 'spree_sociable'
  spec.version     = SpreeSociable::VERSION
  spec.authors     = ['David Freerksen']
  spec.homepage    = 'http://github.com/groundctrl/spree_sociable'
  spec.summary     = 'Let your Spree users be sociable'
